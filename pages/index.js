  ...
  return (
    <div className={styles.container}>
      ...
      <div style={{ backgroundColor: "black", paddingBottom: "60px" }}>
        ...
        <div style={{ margin: "0", padding: "0", backgroundColor: "white", textAlign: "center" }}>
          <a href="#currentimages" style={{ backgroundColor: "", textDecoration: "none", color: "#FF4D10", fontSize: "40px", margin: "2px" }}>-</a>
      ...
      <div style={{ backgroundColor: "black" }}>
        <div style={{ width: "55vw", margin: "auto", paddingTop: "40px", display: "flex", backgroundColor: "pink", paddingBottom: "40px" }}>
          <div style={{ backgroundColor: "", padding: "0", width: "", position: "relative" }}>
            <div style={{ width: "", backgroundColor: "red", height: "", paddingTop: "" }}>
              <div style={{ maxWidth: "80%", backgroundColor: "white" }}>
                <h4>Leading The Way In Building And Civil Construction</h4>
                <h3>Ready to Bring Bigger, Better, Faster, And Stronger Projects Than Ever Before!</h3>
              </div>
              <div style={{ backgroundColor: "", bottom: "0", position: "absolute", whiteSpace: "nowrap" }}>
                <div style={{ paddingTop: "5px", backgroundColor: "", display: "flex" }}>
                  <div style={{ backgroundColor: "#FF4D10", margin: "", display: "flex", borderRadius: "30px" }}>
                  ...
                  <span style={{ paddingLeft: "10px" }}>Quality Control Systen, 100% Satisafaction Guarantee</span>
                </div>
                <div style={{ paddingTop: "5px", backgroundColor: "", display: "flex" }}>
                  <div style={{ backgroundColor: "#FF4D10", margin: "", display: "flex", borderRadius: "30px" }}>
                    <svg style={{ margin: "auto" }} xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="white" class="bi bi-check-circle-fill" viewBox="0 0 16 16"><path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z" /></svg>
                  </div>
                  <span style={{ paddingLeft: "10px" }}>Highly Professional Staff, Accurate testing processes</span>
                </div>
                <div style={{ paddingTop: "5px", backgroundColor: "", display: "flex" }}>
                  <div style={{ backgroundColor: "#FF4D10", margin: "", display: "flex", borderRadius: "30px" }}>
                    <svg style={{ margin: "auto" }} xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="white" class="bi bi-check-circle-fill" viewBox="0 0 16 16"><path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z" /></svg>
                  </div>
                  <span style={{ paddingLeft: "10px" }} >Unrivalled Workmanship Professional And Qualified</span>
                </div>
              </div>
            </div>
          </div>
          <div style={{ backgroundColor: "green", padding: "0", width: "" }}>
      ...
      <div style={{ backgroundColor: "red" }}>
        <div style={{ display: "flex", backgroundColor: "white", padding: "40px", width: "55vw", margin: "auto", borderRadius: "8px" }}>
          <div style={{ backgroundColor: "orange", width: "30%", padding: "10px" }}>
            <div style={{ backgroundColor: "green", height: "200px" }}>
              ...
              <div>
                <header>Quick Contact</header>
                <div>Email: wjbestinsulation@gmail.com</div>
                <div>Support: julian.ma28@gmail.com</div>
              </div>
            </div>
            <div style={{ backgroundColor: "red", height: "200px" }}>
              <div>
                <p>We Will Get back to you within 24 hours, or call us everyday 09:00AM - 12:00PM</p>
                <div>T 732 910 1016</div>
              </div>
            </div>
          </div>
          <div style={{ backgroundColor: "purple", width: "70%", padding: "20px" }}>
            <h2>Request A Quote</h2>
            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Commodi vitae delectus obcaecati omnis unde possimus, quibusdam laudantium cum dolore itaque?</p>
            <form action="/send-data-here" method="post">
              ...
              <div style={{ display: "flex" }}>
                ...
                <div>
                  <label for="email">Select Your Industry</label> <br />
                  <input type="text" id="industry" name="industry" />
                </div>
              </div>
              <div>
                <label htmlFor="detail">Additional Detail</label> <br />
                <input type="text" id="detail" name="detail" />
              </div>
              <div>
                <button type="submit">Submit Request</button>
                <input type="radio" id="last" name="last" /> I accept the Terms & Conditions.
              </div>
            </form>
          </div>
        </div>
      ...
      <div style={{ display: "flex" }}>
        ...
        <div style={{ backgroundColor: "pink" }}>
          <header>what your client's say</header>
          <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Voluptate excepturi voluptates architecto iusto placeat nesciunt consequuntur? Vero ratione dolores unde.</p>
        </div>
      </div>
      ...
      <div style={{ backgroundColor: "purple", paddingBottom: "60px" }}>
        <Row style={{ backgroundColor: "blue", width: "55vw", margin: "auto" }}>
          <Col style={{ backgroundColor: "", padding: "20px" }}>
            <div style={{ backgroundColor: "", height: "300px" }}>
              <Image
