  ...
  return (
    <div className={styles.container}>
      ...
      <div style={{ backgroundColor: "pink" }}>
        ...
        <div style={{ width: "55vw", margin: "auto", paddingTop: "", display: "flex" }}>
          ...
          <div style={{ backgroundColor: "orange", padding: "0", width:"50%" }}>


            <div style={{width:"", backgroundColor:"red", height:"100%"}}>
          ...
          <div style={{ backgroundColor: "green", padding: "0", width:"50%"}}>


            <div style={{ backgroundColor: "white", height: "100%", display: "flex", width:"50%", float:"right" }}>
              <div style={{ backgroundColor: "yellow", margin: "auto", padding:"30px", width:"200px" }}>
                  ...
                  <p style={{ fontSize: ".9em", margin: "0", backgroundColor: "" }}>Utilising latest processing solution and decades of work experience.</p>
